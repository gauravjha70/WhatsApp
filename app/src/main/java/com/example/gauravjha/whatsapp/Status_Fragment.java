...
public class Status_Fragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = rootview.findViewById(R.id.status_recycler);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        floatingActionButton.setImageResource(R.drawable.status_camera_button);
    }
